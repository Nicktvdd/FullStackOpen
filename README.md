...
Check out the phonebook [here](https://phonebook-nsae.onrender.com). It's created with React, Node, Express, Vite and hosted on Render, and still a work in progress.
